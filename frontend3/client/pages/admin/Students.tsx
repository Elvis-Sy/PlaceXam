...
interface Student { matricule: string; nom: string; prenom: string; filiere: string; niveau: string; }
...
export default function Students() {
  ...
  const filtered = useMemo(() => {
    ...
    return students.filter((s) =>
      [s.matricule, s.nom, s.prenom, s.filiere, s.niveau].some((v) => v.toLowerCase().includes(q)),
    );
  }, [students, query]);
  ...
  function exportCSV() {
    ...
    a.href = url; a.download = "etudiants.csv"; a.click(); URL.revokeObjectURL(url);
  }
